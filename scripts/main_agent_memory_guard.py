...
def main() -> None:
    ...
    parser.add_argument("--token-threshold", type=int, default=24000)
    parser.add_argument("--hard-threshold", type=int, default=32000)
    parser.add_argument("--excerpt-chars", type=int, default=1200)
    parser.add_argument("--checkpoint-max-chars", type=int, default=8000)
    parser.add_argument("--checkpoint-dir", default="ai_company")
